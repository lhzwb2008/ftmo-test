...
//--- 输入参数
input string   DBPath = "trading_signals_e8.db";           // SQLite数据库文件名（E8 Markets）
input bool     UseCommonPath = true;                   // 使用通用目录（推荐）
input int      MagicNumber = 20260707;                 // 魔术数字（与其他 EA 区分）
input double   Leverage = 2;                        // 杠杆倍数（E8 Pro 挑战期 2 / Funded 改 1.5）
...
input double   DailyLossPercent = 2.5;                 // 官方日内最大亏损比例(%)（E8 Pro 官方 2.5；0=禁用）
