...
# 风控比例（The5ers High Stakes Classic 旧版规则: Phase1 目标 8% / Phase2 5% / Funded 无目标；最大日亏均 5%。新版 Phase1 为 10%）
PHASE_PROFIT_TARGET_PCT = {"1": 0.08, "2": 0.05, "funded": -1}  # 各轮次止盈目标比例（负数=禁用止盈；新版 Phase1 请改 0.10）
...
TRADING_END_TIME = (15, 41)   # 交易结束时间：15点41分
...
DB_PATH = os.path.join(get_common_files_dir(), "trading_signals_the5ers.db")
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("长桥API交易策略启动 - 模拟模式 (The5ers)")
    print("=" * 60)
