...
input double   AccountInitialBalance = 100000.0;       // 账户初始资金（务必改为实际账户初始资金）
input double   DailyLossPercent = 5.0;                 // 官方日内最大亏损比例(%)（TTP 2-Phase 官方 5 / 1-Phase 请改 3；0=禁用）
