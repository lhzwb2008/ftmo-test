...
- **Trading simulators** (`simulate_ftmo.py`, `simulate_fundednext.py`, `simulate_the5ers.py`, `simulate_icmarkets.py`, `simulate_ttp.py`, `simulate_blueberry.py`, `simulate_goat.py`) require Longport API credentials via a `.env` file or environment variables:
  - `LONGPORT_APP_KEY`
  - `LONGPORT_APP_SECRET`
