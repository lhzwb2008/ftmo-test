...
# 风控比例（Goat Funded Trader 2-Step Standard 官方规则: Phase1 目标 10% / Phase2 5% / Funded 无目标；最大日亏均 5%。GOAT/PRO 模型: P1 8% / P2 4-6%、日亏 4%）
...
DAILY_LOSS_PCT = 0.045     # 日内止损比例（Standard 官方 5%，留 10% 缓冲；GOAT/PRO 模型 4% 时请改为 0.036）
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("长桥API交易策略启动 - 模拟模式 (Goat Funded Trader)")
    print("=" * 60)
